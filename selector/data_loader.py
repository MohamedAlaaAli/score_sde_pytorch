...
class EfficientDataLoader:
    def __init__(self, dataset_path, batch_size=1, num_workers=8, train_split=0.8, val_split=0.01, cache_data=False, device="cuda" if torch.cuda.is_available() else "cpu"):
        """
